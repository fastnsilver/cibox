...
This folder contains the Dockerfile and associated files for the ```alstom/jira``` docker image which aims to make it a breeze getting an Atlassian Jira instance up and running.
